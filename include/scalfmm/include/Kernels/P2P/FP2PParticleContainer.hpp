...
class FP2PParticleContainer : public FBasicParticleContainer<FReal, NVALS*(NRHS+4*NLHS), FReal, 3, FAlignedAllocator<FP2PDefaultAlignement,char>, OtherAttrs...> {
    using Parent = FBasicParticleContainer<FReal, NVALS*(NRHS+4*NLHS), FReal,
